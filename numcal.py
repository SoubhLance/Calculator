...
btn_7 = tk.Button(root,text="7", command=lambda: add_to_calculation(7), width=8, height=2, font=("Arial",14))
btn_7.grid(row=4, column=0)
btn_8 = tk.Button(root,text="8", command=lambda: add_to_calculation(8), width=8, height=2, font=("Arial",14))
btn_8.grid(row=4, column=1)
btn_9 = tk.Button(root,text="9", command=lambda: add_to_calculation(9), width=8, height=2, font=("Arial",14))
btn_9.grid(row=4, column=2)
btn_0 = tk.Button(root,text="0", command=lambda: add_to_calculation(0), width=8, height=2, font=("Arial",14),padx=2,pady=6)
...
btn_minus = tk.Button(root,text="-", command=lambda: add_to_calculation("-"), width=8, height=2, font=("Arial",14))
btn_minus.grid(row=3,column=3)
btn_mul = tk.Button(root,text="*", command=lambda: add_to_calculation("*"), width=8, height=2, font=("Arial",14))
btn_mul.grid(row=2,column=3)
btn_div = tk.Button(root,text="/", command=lambda: add_to_calculation("/"), width=8, height=2, font=("Arial",14))
btn_div.grid(row=1,column=3)
btn_open = tk.Button(root,text="(", command=lambda: add_to_calculation("("), width=8, height=2, font=("Arial",14))
btn_open.grid(row=1,column=1)
btn_dot = tk.Button(root,text=".", command=lambda: add_to_calculation("."), width=8, height=2, font=("Arial",14),padx=2,pady=6)
btn_dot.grid(row=5,column=0)
btn_close = tk.Button(root,text=")", command=lambda: add_to_calculation(")"), width=8, height=2, font=("Arial",14))
